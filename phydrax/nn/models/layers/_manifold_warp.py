...
class ManifoldMultiheadWarp(StrictModule):
    ...
    def __init__(
        ...
        *,
        ...
        hidden = self.out_channels if displacement_width is None else int(displacement_width)
        if hidden <= 0:
        ...
        *,
        ...
        if self.displacement_condition is None:
            if condition is not None:
                raise ValueError("condition must be None for an unconditioned manifold warp.")
        else:
    ...
    def _evaluate(
        ...
        *,
        ...
        sampled = jnp.einsum("...hqs,...hsc->...hqc", weights, projected)
