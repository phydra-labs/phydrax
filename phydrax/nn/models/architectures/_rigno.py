...
from ..core._operator_geometry import RegionalGeometryMode, RegionalPointLatentGeometry
...
from ._geometry_operator import _GeometryOperatorCore


class RIGNO(_AbstractOperatorModel):
