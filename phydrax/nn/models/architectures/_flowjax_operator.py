...
from ..core._operator import FunctionSamples, OperatorBatch, OperatorOutputSpec
from ..core._operator_distribution import (
    AbstractOperatorDistribution,
    AbstractProbabilisticOperatorModel,
)
from ._deeponet import _AbstractBranchEncoder
...
class ConditionalFlowFunctionOperator(AbstractProbabilisticOperatorModel):
    ...
    location_model: _AbstractOperatorModel
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(location_model, _AbstractOperatorModel):
