...
class DeepONet(_AbstractOperatorModel):
    ...
    def __call_operator_batch__(
        ...
        *,
        ...
        output = output * batch.require_single_query().mask_array(case_shape=batch.case_shape)[..., None]
    ...
    def __call__(
        ...
        *,
        ...
        batch = OperatorBatch(inputs={name: FunctionSamples(values=jnp.asarray(x[0]))}, queries={"query": query}, )
