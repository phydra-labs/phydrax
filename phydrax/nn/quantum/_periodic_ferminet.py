...
def _determinant_signed_log(orbitals: Array, /) -> tuple[Array, Array]:
    prepared = factorize(
        DenseLinearOperator(orbitals),
        FactorizationPolicy("lu"),
    )
    return prepared.log_abs_determinant(), prepared.determinant_sign()
...
def _complex_determinant_mixture(
    matrices: Array,
    coefficients: Array,
    /,
