...
class LocalIntegralOperator(AbstractOperatorModel):
    """Coordinate-kernel integral operator with physical-radius neighborhoods."""

    operator_architecture = "LocalIntegralOperator"
...
class LocalDifferentialOperator(AbstractOperatorModel):
    """Constant-preserving localized nonlocal differential kernel."""

    operator_architecture = "LocalDifferentialOperator"
...
class LocalGlobalOperator(AbstractOperatorModel):
    """Compose global and localized operator paths over one OperatorBatch."""

    operator_architecture = "LocalGlobalOperator"

    global_operator: AbstractOperatorModel
