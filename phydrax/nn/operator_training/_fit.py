...
from ..models.core._keys import split_eval_key
from ..models.core._loss import model_loss_labels, model_loss_values
...
from ._sampling import OperatorCaseSource
...
class OperatorFitResult:
    ...
    last_execution_model: _AbstractOperatorModel
