...
def _samples_with_values(samples: FunctionSamples, values: Array, /) -> FunctionSamples:
...
def _batch_with_source(
    ...
    inputs[source_name] = _samples_with_values(inputs[source_name], values)
...
def _predict(
    ...
    if isinstance(operator, _AbstractOperatorModel):
