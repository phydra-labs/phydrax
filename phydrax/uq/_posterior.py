...
class ParameterSubspace(StrictModule):
    """Explicit selected leaves and frozen complement of a model PyTree."""
    ...
    def last_layer(
        ...
        *,
        ...
        if count > len(available):
            raise ValueError("num_leaves exceeds the model's array-leaf count.")
        return cls.from_leaf_paths(tree, available[-count:])
