...
_CORRECTIONS = (
    ...
    (
        ...
        "pitch / sqrt(12.)",
        2,
        "Do not convert pitch from micrometers to centimeters twice.",
    ),
    (
        "G4_FST_EIC.C",
        ...
        1,
        "Use the barrel percent-X0 to centimeter conversion in disk interpolation.",
    ),
    (
        "G4_FST_EIC.C",
    ...
    *,
    ...
    metadata: dict[str, Any] = {
        ...
        "geometry_semantics": (
            ...
            "pitch = micrometers; tracking sigma = pitch_cm / sqrt(12)",
            "barrel thickness = percent radiation length; silicon X0 = 9.37 cm",
            "disk silicon thickness = micrometers",
        ),
