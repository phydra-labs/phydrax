...
class ConstantStateBoundary(AbstractConservationBoundary):
...
class PrescribedStateBoundary(AbstractConservationBoundary):
...
class PrescribedNormalFluxBoundary(AbstractConservationBoundary):
