...
The source atlas pins every reviewed repository revision, content-addressed Git tree or archive, README, and licence or download-terms document. Review status is technical, not final legal approval. Strong-copyleft and source-available sources remain provider-only.
