...
- **FunctionalSolver**: sums terms and model losses into a differentiable scalar functional and runs Optax, structured KFAC, native distribution evolution, or explicit product-manifold optimization.
