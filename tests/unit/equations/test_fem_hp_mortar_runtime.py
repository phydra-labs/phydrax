...
def test_asymmetric_workset_accepts_independent_side_widths_and_mortar_data():
    ...
    signature = WorksetSignature(
        ...
        element_id="left-element",
        coordinate_element_id="coordinate-element",
        prepared_reference_id="left-reference",
        neighbour_element_id="right-element",
        neighbour_prepared_reference_id="right-reference",
